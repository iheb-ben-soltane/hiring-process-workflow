...
import tn.enit.handler.EmbaucherCondidatServiceHandler;
...
public class Main {
	...
	private static final String ENVOI_ERP_JOB_TYPE = "embaucherLeCondidat";
		...
		try (final ZeebeClient client =
			...
			final JobWorker envoiERP_worker =
				    client.newWorker()
				        ...
				        .handler(new EmbaucherCondidatServiceHandler())
