...
import tn.enit.handler.EnvoyerDecisionContratHandler;
...
public class Main {
    ...
    private static final String ENVOYER_DECISION_CONTRAT_JOB_TYPE = "envoyerDecisionContrat";
    ...
    public static void main(String[] args) {
        ...
        try (final ZeebeClient client =
            ...
            final JobWorker envoyerDecisionContratWorker = client.newWorker()
                    .jobType(ENVOYER_DECISION_CONTRAT_JOB_TYPE)
                    .handler(new EnvoyerDecisionContratHandler())
            ...
            sc.nextInt();
            sc.close();
            envoyerDecisionContratWorker.close();
